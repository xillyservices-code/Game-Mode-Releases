...
4. **Game**: Launch your favorite title and enjoy smoother performance.
5. **Restore**: When finished, click **"Deactivate"** to bring everything back to normal.

## 🛠️ Support & Optimization

**Something not running right?** 
If a specific game or app struggles with Game Mode, simply deactivate it.

**Want to check your specs?**
